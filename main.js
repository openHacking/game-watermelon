...
window.boot = function () {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'https://cdn.jsdelivr.net/gh/openHacking/game-watermelon@release-v1.0.7/src/project.js';
        if (jsList) {
            jsList = jsList.map(function (x) {
                return 'https://cdn.jsdelivr.net/gh/openHacking/game-watermelon@release-v1.0.7/src/' + x;
            });
    ...
    cc.AssetLibrary.init({
        libraryPath: 'https://cdn.jsdelivr.net/gh/openHacking/game-watermelon@release-v1.0.7/res/import',
        rawAssetsBase: 'https://cdn.jsdelivr.net/gh/openHacking/game-watermelon@release-v1.0.7/res/raw-',
